...
const Navbar = ({toggleMode}) => {
    ...
    const navLink = <>
        ...
        {
            userFromDb.role === 'user' &&  <li className=''><NavLink to='/upgrade'>Upgrade to PRO</NavLink></li> 
        }
        {
            userFromDb.role === 'surveyor' && <li className=''><NavLink to='/dashboard/create'>Dashboard</NavLink></li>
        }
        {
            userFromDb.role === 'Admin' && <li className=''><NavLink to='/dashboard/adminhome'>Dashboard</NavLink></li>
        }
        ...
        <div className='navbar pb-2 bg-[#D6FFB7]'>
            <div className="navbar-start">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className={`menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow  bg-[#D6FFB7] rounded-box w-52`}>
                        {navLink}
                    </ul>
                </div>
